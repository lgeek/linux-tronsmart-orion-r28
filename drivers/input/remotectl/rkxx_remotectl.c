...
static struct rkxx_remote_key_table remote_key_table_nec[] = {
#if 0 //copied from mlogic
   {0x1b, KEY_BACK}, 		// back
   {0x49, KEY_MENU},			// menu
    ...
    {0x51, KEY_POWER},     //power
    {0x53, KEY_HOME},     //home

    {0x52, 388},     //TV_KEYMOUSE_MODE_SWITCH
    {0x31, KEY_1},
    {0x32, KEY_2},
    {0x33, KEY_3},
    {0x34, KEY_4},
    ...
    {0x58, 389}, //DIGITAL_ALPHABET_SWITCH
    {0xbd, 122}, //previous
    {0xbb, 123}, //next
    {0x09, 393}, //MEDIA_PLAYER
    {0x11, 390}, //MUSIC_PLAYER
    {0x54, 391}, //BROWSER_APP
    {0x4f, 392}, //ALL_APP
#endif
    ...
    {0x2a,   185},//web
    {0xf2,   186},//app
    {0x72, KEY_VOLUMEUP},//zgq KEY_VOLUMEDOWN->KEY_VOLUMEUP 131220
    {0xbd, 0x190},//KEY_CHANNELDOWN},//channel -
    {0xdd, 0x191},//KEY_CHANNELUP},//channel +
    {0x6a, KEY_VOLUMEDOWN},//zgq KEY_VOLUMEUP->KEY_VOLUMEDOWN 131220
    {0xca, KEY_HOME},          //rorate right 
    {0xd8, KEY_BACK},     //home
    ...
    {0x1c,   KEY_8},//8
    {0x9c,   KEY_9},//9
    {0x1a,   KEY_CAPSLOCK},//tab
    {0x0c,   KEY_0},//0
    {0x22,   KEY_BACKSPACE  },//delete
...
static struct rkxx_remotectl_button remotectl_button[] = 
{
    ...
    {  
       .usercode = 0x1fe,
       .nbuttons =  31, 
       .key_table = &remote_key_table_nec[0],
    },
};
